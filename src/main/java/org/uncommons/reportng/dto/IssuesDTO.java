...
public class IssuesDTO {
	...
	private Map<String, List<IssueDTO>> skippedIssues;
	private Map<String, List<IssueDTO>> skippedIssuesRegression;
	private Map<String, List<IssueDTO>> skippedIssuesNewFeature;
	
	private int newIssuesAmount;
	private int fixedIssuesAmount;
	private int knownIssuesAmount;
	private int skippedIssuesAmount;
	...
	public IssuesDTO() {
		...
		skippedIssues = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
		skippedIssuesRegression = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
		skippedIssuesNewFeature = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
	}
	...
	public Map<String, List<IssueDTO>> getSkippedIssues() {
		return skippedIssues;
	}
	
	public void setSkippedIssues(Map<String, List<IssueDTO>> skippedIssues) {
		this.skippedIssues = skippedIssues;
	}
	
	public Map<String, List<IssueDTO>> getSkippedIssuesRegression() {
		return skippedIssuesRegression;
	}
	
	public void setSkippedIssuesRegression(Map<String, List<IssueDTO>> skippedIssuesRegression) {
		this.skippedIssuesRegression = skippedIssuesRegression;
	}
	
	public Map<String, List<IssueDTO>> getSkippedIssuesNewFeature() {
		return skippedIssuesNewFeature;
	}
	
	public void setSkippedIssuesNewFeature(Map<String, List<IssueDTO>> skippedIssuesNewFeature) {
		this.skippedIssuesNewFeature = skippedIssuesNewFeature;
	}

	public int getSkippedIssuesAmount() {
		return skippedIssuesAmount;
	}

	public void setSkippedIssuesAmount(int skippedIssuesAmount) {
		this.skippedIssuesAmount = skippedIssuesAmount;
	}
